    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-[#e0e5ec]">
            <div className="w-96 p-8 rounded-2xl bg-[#e0e5ec] shadow-[8px_8px_16px_#bec3cf,-8px_-8px_16px_#ffffff]">
                <h2 className="text-xl font-semibold text-center text-[#3d4468]">Criar Conta</h2>
                <p className="text-sm text-center text-[#9499b7] mb-6">Preencha os campos abaixo</p>
                ...
                <input
                    ...
                    className="w-full px-4 py-3 mb-6 rounded-lg bg-[#e0e5ec] shadow-[inset_4px_4px_8px_#bec3cf,inset_-4px_-4px_8px_#ffffff] focus:outline-none"
                />
                ...
                <p className="text-center text-sm mt-6 text-[#9499b7]">
                    Já tem conta? <a href="/login" className="text-[#3d4468] font-semibold">Entrar</a>
                </p>
            </div>
        </div>
    );
