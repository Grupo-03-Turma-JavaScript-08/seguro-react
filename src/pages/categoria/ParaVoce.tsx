...
export default function ParaVoce() {
    ...
    return (
        <>
                ...
                <section className="flex flex-col items-center py-20 bg-gradient-to-b from-[#ffffff] via-[#f8fafc] to-[#e6f4f3]">
                ...
                <section className="py-20 bg-gradient-to-b from-[#e6f4f3] to-[#d3ebe8] text-center text-[#00332E]">
                    <h3 className="text-3xl font-bold mb-8 text-[#fa7143]">
                    ...
                    <div className="flex flex-wrap justify-center gap-10 px-4">
                        {[
                            ...
                            <div
                                key={i}
                                className="max-w-sm bg-white/90 backdrop-blur-sm shadow-lg border border-[#fa7143]/20 p-6 rounded-xl
                                hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                            >
                                <p className="italic text-gray-700">{d.frase}</p>
                                <span className="block mt-3 font-semibold text-[#fa7143]">
                                {d.nome}
                                </span>
                            </div>
                        ))}
